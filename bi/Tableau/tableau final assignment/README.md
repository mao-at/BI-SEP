...
Additional files for example - If you have used python file to clean up or manipulate the data. Please upload the file to the assignment along with the tableau profile link.

Here is link for citibike data resources - https://citibikenyc.com/system-data
